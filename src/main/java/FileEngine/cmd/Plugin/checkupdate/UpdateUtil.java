package FileEngine.cmd.Plugin.checkupdate;

import FileEngine.cmd.Plugin.Plugin;
...
public class UpdateUtil {
    ...
    private static JSONObject getVersionInfo() throws IOException {
        String fileName = "cmdPluginUpdate.json";
        String savePath = "tmp";
        String url = "https://cdn.jsdelivr.net/gh/XUANXUQAQ/File-Engine-Version/Plugins%20Repository/CmdPluginVersion.json";
        try {
